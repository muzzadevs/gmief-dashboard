  ...
  return (
    <main className="min-h-screen max-h-screen flex flex-col font-sans bg-gradient-to-br from-blue-900 via-white to-blue-400">
      ...
      <div className="w-full flex justify-center z-[1000] mb-4 sm:sticky sm:top-0">
        <div className="mt-4 w-[95%] rounded-2xl border border-gray-200 bg-white/90 backdrop-blur px-4 sm:px-6 py-4 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mb-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-black text-white font-semibold text-sm shadow hover:bg-gray-900 transition border border-black cursor-pointer sm:w-auto"
              onClick={() => {
          ...
          <div className="flex flex-col xs:flex-row items-stretch gap-2">
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-green-600 text-white font-semibold text-xs sm:text-sm shadow hover:bg-green-700 transition border border-green-600 cursor-pointer flex-1"
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-blue-600 text-white font-semibold text-xs sm:text-sm shadow hover:bg-blue-700 transition border border-blue-600 cursor-pointer flex-1"
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-white font-semibold text-xs sm:text-sm shadow transition border cursor-pointer flex-1"
